    ...
    <div className="min-h-screen bg-black text-white">
      <div className="pt-24 px-4 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">Innovative Technology Solutions for a Digital Future</p>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Pushing boundaries with cutting-edge technology solutions</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Putting our clients' success at the heart of everything we do</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-gray-900/50 border border-gray-800 rounded-lg">
              ...
              <p className="text-gray-400">Tailored solutions built to meet your specific business requirements</p>
            </div>
            <div className="p-6 bg-gray-900/50 border border-gray-800 rounded-lg">
              <h3 className="text-xl font-semibold mb-2">Cloud Solutions</h3>
              <p className="text-gray-400">Scalable cloud infrastructure and migration services</p>
            </div>
            <div className="p-6 bg-gray-900/50 border border-gray-800 rounded-lg">
              <h3 className="text-xl font-semibold mb-2">Digital Transformation</h3>
              <p className="text-gray-400">Comprehensive digital strategies to modernize your business</p>
            </div>
          </div>
        </div>
